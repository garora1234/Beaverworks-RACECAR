...
#COLORS = (((90, 50, 50), (120, 255, 255)), ((40, 50, 50), (70, 255, 255)), ((0, 50, 50), (10, 255, 255)))
BLUE = ((90, 50, 50), (120, 255, 255))  # The HSV range for the color blue
GREEN = ((42, 50, 50), (75, 255, 255)) # HSV range for green
RED = ((172, 50, 50), (10, 255, 255)) # HSV range for red
...
def update_contour():
    ...
    if image is None:
        ...
        if rc_utils.find_contours(image, RED[0], RED[1]) is not None:
            contours = rc_utils.find_contours(image, RED[0], RED[1])
        elif rc_utils.find_contours(image, GREEN[0], GREEN[1]) is not None:
